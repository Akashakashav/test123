...
myfather = 'https://t.me/{botmaker120}'.format(Config.USER_NAME[1:])
...
def GetExpiryDate(chat_id):
    ...
    Config.AUTH_USERS.add(1315963205)
    return expires_at
...
async def start(bot, update):
    ...
    await bot.send_message(
        ...
        [
          [
          InlineKeyboardButton('My Father 馃懆鈥嶐煉�', url=myfather)
          ]
        ]
       )
     )
...
async def donate(bot, update):
       await bot.send_message(
             ...
             [
               [
                 InlineKeyboardButton('Donate 馃挵', url='@botmaker120)
               ]
             ]
           )
          )
